...
function PWLengthCriteria (){
    ...
    var passwordLength = prompt("Enter your desired password length from 8-128 characters, make sure to only type numbers!");
...
PWLengthCriteria.passwordLength
//as of rn this function is not allowing me to loop through, ovbi, but at least the error is going through 
//there is also an error where no matter what i enter i am getting the error message
